...
public class RegisterPojo {
	 private int sl_no;
		...
		public RegisterPojo(int sl_no,String business_code, String cust_number, String clear_date, int buisness_year,
				String doc_id, String posting_date, String document_create_date, String document_create_date1,
				String due_in_date, String invoice_currency, String document_type, String posting_id,
				String area_business, String total_open_amount, String baseline_create_date, String cust_payment_terms,
				String invoice_id, String isOpen, String aging_bucket, String is_deleted) {
			//super();
			this.sl_no=sl_no;
			this.business_code = business_code;
			this.cust_number = cust_number;
